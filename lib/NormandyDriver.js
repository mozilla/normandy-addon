...
exports.NormandyDriver = function(recipeRunner, sandbox, extraContext) {
  return {
    ...
    showStudyConsentPage(options) {
      Log.debug(`Showing Study Consent Page`);
      tabs.open({
        url: 'resource://shield-study/consent-page.html',
        onReady: tab => {
          const worker = tab.attach({
            contentScriptFile: 'resource://shield-study-js/consent-page.js',
